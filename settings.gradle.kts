...
include(":business:book-shelf:book-shelf-api")
...
include(":business:book-detail")
include(":business:book-detail:book-detail-impl")
include(":business:book-detail:book-detail-api")